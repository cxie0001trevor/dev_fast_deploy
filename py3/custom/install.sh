...
pipenv install --deploy --system > nbextensions_install.log

echo "> Setting up notebook extensions ..."
# Install jupyter themes
sudo -H pip install --no-cache-dir jupyterthemes >> nbextensions_install.log

# Install jupyter extensions
sudo -H pip install --no-cache-dir jupyter_contrib_nbextensions >> nbextensions_install.log
